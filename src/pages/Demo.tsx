  ...
  <div className="min-h-screen bg-background">
    ...
    <div className="pt-32 pb-24">
      <div className="container max-w-4xl text-center">
        <h1 className="text-3xl md:text-5xl font-extrabold mb-6">Veja o VenusClip em ação</h1>
        <p className="text-muted-foreground text-lg mb-12 max-w-xl mx-auto">
          Assista como transformamos um vídeo longo em clips otimizados em minutos
        </p>
        <div className="aspect-video rounded-2xl venus-card flex items-center justify-center">
